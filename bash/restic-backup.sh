...
echo "Desbloqueando repositorio remoto si existen bloqueos obsoletos..."
sudo -E restic -r "$REPO_REMOTE" unlock
...
echo "Desbloqueando repositorio local si existen bloqueos obsoletos..."
sudo -E restic -r "$REPO_LOCAL" unlock
