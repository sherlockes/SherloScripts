...

;;;### (autoloads nil "dired-sort-menu" "dired-sort-menu.el" (0 0
;;;;;;  0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dired-sort-menu" '("dired-sort-" "keymap" "ls-lisp-var-p")))
