...
*** Edición
**** Comentar varias líneas seleccionadas -> M-; (Con las líneas preseleccionadas)
**** Sangrar varias líneas 8 -> C-u 8 C-x Tab
**** Reemplazar cadena --> M-x replace-string
...
**** Corta la siguiente palabra -> M-d
**** Corta la palabra anterior -> M-<back>
...
- Eliminar sensor "Puerta de la galeria"
- Reiniciar sensor
 - Detectar sensores desde Phoscon
 - Pulsar reset con la aguja durante 5 sg
- Renombrar sensor "Puerta de la galeria"
